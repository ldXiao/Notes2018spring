...
\begin{tikzcd}
 & \calo(U_i)^d \arrow[rd] &  \\
\calf(U_i) \arrow[ru, "\phi_i"] \arrow[rd, "\res"] &  & \calo(U_i\cap U_j)^d \arrow[dd, "T_{ij}"] \\
 & \calf(U_i\cap U_j) \arrow[rd, "\simeq"] \arrow[ru, "\simeq"] &  \\
\calf(U_j) \arrow[ru, "\res"] \arrow[rd, "\phi_j"] &  & \calo(U_i\cap U_j)^d \\
 & \calo(U_j)^d \arrow[ru] & 
\end{tikzcd}
$$
\end{proof}
...
We have
$$
\phom(\calf,\calg)(U)\cong\hom_{\calo_X}(\calo_U^{\oplus m},\calo_U^{\oplus n}).
$$
