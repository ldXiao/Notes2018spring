...
Many big theorems in the lecture were stated without proof. We list the reference for most of them. One notable exception is Riemann-Roch theorem, which is used only in application level in this lecture, and we don not want to introduce Serre duality or cohomology in the notes.
