...
\end{lemma}
\begin{proof}(of the lemma)
If $K$ is a finite field, then $K^n$ is a finite vector space (as set). The theorem holds trivially because any injection of finite set to itself is a bijection. When $K$ is  the algebraic closure of a finite field, the result follows from Hilbert' Nullstellensatz.
\end{proof}
